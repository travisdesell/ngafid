        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading"><b>My Flights - {{$pageName}}</b> <span class="pull-right">{{date("D M d, Y G:i A T")}}</span></div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    {!! Form::select('perPage', array('' => 'Select option', 20 => '20', 50 => '50', 100 => '100'), $selected['perPage'], ["class" => "form-control"]) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
                        ...
                        {!! Form::hidden('duration', $selected['duration'], array('id' => 'duration')) !!}
                            ...
                            <table class="table table-hover table-condensed" style="border-collapse:collapse;margin:0px;">
                                <thead>
                                    <tr>
                                        ...
                                        <!-- <th class="col-md-2 text-left">N Number</th> -->
                            ...
                            <div class="div-table-content">
                                ...
                                @foreach ($data as $flight)
                                    <tr data-toggle="collapse" data-target="#expand{{$flight['id']}}" class="clickable">
                                        ...
                                        <!-- <td class="col-md-2 text-left" data-title="N Number">{{$flight['n_number']}}&nbsp;</td> -->
                                        <td class="col-xs-2 text-left text-nowrap" data-title="Aircraft">{{$flight['aircraft name']}}</td>
                                        ...
                                        <td class="col-xs-3 text-center text-nowrap" data-title="More Options">
                                            ...
                                            @if($flight['num_events'] > 0 && \Route::is('flights/event'))
                                                <b>Exceedance Details:</b><a href="#summary" class="displaySummary" data-toggle="modal" data-link="{{URL::route('flights/download', $flight['id'] . '/data/'. $selected['event'] . '/30') }}"><span class="glyphicon glyphicon-list-alt text-warning"></span></a><br>
                                            @endif
                                            <div class="btn-group">
                                        ...
                                        <td colspan="12" class="hiddenRow">
                                            <div class="collapse" id="expand{{$flight['id']}}">
                                                <div class="col-md-3 col-md-offset-1">
                                                    ...
                                                    <b>Aircraft:</b> {{$flight['aircraft name'] . ' - ' . $flight['year'] . ' ' . $flight['make'] . ' ' . $flight['model']}}<br>
                    ...
                    <div class="modal fade" id="download" tableindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>This flight data has one or more exceedance(s). Download the replay for 30 seconds
                                        (or 60 seconds) before and after the event. You may also download the entire flight.</p>
                                    <div class="radio">
                                        <label><input type="radio" name="option" value="30">+/- 30 Seconds</label>
                                    </div>
                                    <div class="radio">
                                        <label><input type="radio" name="option" value="60">+/- 60 Seconds</label>
                                    </div>
                                    <div class="radio">
                                        <label><input type="radio" name="option" value="0" checked="">Entire Flight</label>
                                    </div>
                                    <!--<input type="text" name="dwldURL" id="dwldURL" value=""/>-->
                                </div>
                                <div class="modal-footer">
                                    <a href="#" class="btn btn-primary" id="dwldFlight" data-link="">Download</a>
                                    <a href="#" class="btn btn-default" data-dismiss="modal">Close</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="confirm-duration" title="Enter duration" style="display: none;">
                        <p><input id="hours" name="value" value=0 size=2/> : <input id="minutes" name="value" value=0  size=2/> <i>(hh:mm)</i></p>
                    </div>
