        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading"><b>My Flights
                                                  - {{ $pageName }}</b>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    {!! Form::select('filter', array('' => 'All flights', 'E' => 'Flights with events', 'A' => 'Archived Flights'), $selected['filter'], ["class" => "form-control"]) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Sort
                                                                      by:</label>
                                <div class="col-md-8">
                                    {!! Form::select('sort', array('' => 'Select option', 1 => 'Exceedance (high-low)', 2 => 'Date (low-high)', 3 => 'Destination', 4 => 'Origin', 5 => 'Duration'), $selected['sortBy'], ["class" => "form-control", "id" => "sort"]) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            @if (Auth::user()->fleet->isUND())
                                <div class="form-group">
                                    <label class="col-xs-6 control-label">Flight
                                                                          ID</label>
                                    <div class="col-xs-6">
                            ...
                            <div class="form-group">
                                <label class="col-xs-6 control-label">No.
                                                                      Flights
                                    <i>
                            ...
                            <table class="table table-hover table-condensed"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-xs-2 text-left">Route
                                        </th>
                                        <th class="col-xs-2 text-left">Date</th>
                                        <th class="col-xs-1 text-center">Time
                                        </th>
                                ...
                                <table class="table">
                                    <tbody>
                                        <?php
                                            ...
                                            $showDecryptedData = Session::get('toggleEnc') === 'F' && count(Session::get('encrSK')) > 0
                                        ?>
                                        ...
                                        @foreach ($data as $flight)
                                            <tr data-toggle="collapse"
                                                ...
                                                <td class="col-xs-2 text-left text-nowrap"
                                                    data-title="Aircraft">{{$flight['aircraft name']}}</td>
                                                <td class="col-xs-2 text-left text-nowrap"
                                                    data-title="Origin">
                                                    {{ $flight['origin'] }} &rArr; {{ $flight['destination'] }}</td>
                                                <td class="col-xs-2 text-left text-nowrap"
                                                    data-title="Date">
                                                ...
                                                <td class="col-xs-1 text-center text-nowrap"
                                                    data-title="Time">
                                                    {{ $flight['time'] }}
                                                </td>
                                                ...
                                                <td class="col-xs-3 text-center text-nowrap"
                                                    data-title="More Options">
                                                    <a href="{{ URL::route('flights.edit', $flight['id']) }}"
                                                       class="glyphicon glyphicon-pencil"
                                                       title="Edit flight"></a>
                                                    &nbsp;&nbsp;
                                                    <a href="{{ URL::route('flights/chart', $flight['id']) }}"
                                                       class="glyphicon glyphicon-stats"
                                                       title="Flight stats"></a>
                                                    &nbsp;&nbsp;
                                                    <div class="btn-group">
                                                        <a href="#"
                                                           class="glyphicon glyphicon-download-alt"
                                                           data-toggle="dropdown"
                                                           title="Download flight"></a>
                                                        &nbsp;&nbsp;
                                                    ...
                                                    <a href="#"
                                                       id="replayFlight{{ $flight['id'] }}"
                                                       data-link="{{ URL::route('flights/load', $flight['id']) }}"
                                                       class="glyphicon glyphicon-plane"
                                                       title="Replay flight"></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="12"
                                                    ...
                                                    <div class="collapse"
                                                        ...
                                                        <div class="col-md-3 col-md-offset-1">
                                                            @if ($fleet->wantsDataEncrypted)
                                                                @if ($showDecryptedData)
                                                                    <?php openssl_private_decrypt( base64_decode($flight['n_number']), $decrNumber, base64_decode( gzuncompress(Session::get('encrSK')) ) ); ?>
                                                                    <b>N Number:</b> {{ $decrNumber }} <br />
                                                                @else
                                                                    <b>N Number:</b> ***** <br />
                                                                @endif
                                                            @else
                                                            ...
                                                            <b>Aircraft:</b> {{ $flight['aircraft name'] . ' - ' . $flight['year'] . ' ' . $flight['make'] . ' ' . $flight['model'] }}
                                                            <br />
                                                            <b>Edit Flight:</b>
                                                            <a href="{{ URL::route('flights.edit', $flight['id']) }}"
                                                               class="glyphicon glyphicon-pencil"
                                                        ...
                                                        <div class="col-md-3 col-md-offset-1">
                                                            <b>View Charts:</b>
                                                            <a href="{{ URL::route('flights/chart', $flight['id']) }}"
                                                               class="glyphicon glyphicon-stats"></a>
                                                            <br>
                                                            <b>Replay Flight:</b>
                                                            <a href="#"
                                                               id="replayFlight{{ $flight['id'] }}"
                                                        ...
                                                        <div class="col-md-3 col-md-offset-1">
                                                            <b>No. Exceedance:</b> {{ $flight['num_events'] }}
                                                            <br />
                                                            @if ($flight['num_events'] > 0 && Route::is('flights/event'))
                                                                <b>Exceedance Details:</b>
                                                                <a href="#summary"
                                                                   class="displaySummary"
                                                                   data-toggle="modal"
                                                                   data-link="{{ URL::route('flights/download', $flight['id'] . '/data/'. $selected['event'] . '/30') }}">
                                                            ...
                                                            @if ($flight['archived'] == 'N')
                                                                <b>Archive Flight:</b>
                                                                <a href="{{ URL::route('flights/archive', $flight['id']) }}"
                                                                   class="glyphicon glyphicon-trash"
                                                                   title="Archive exceedance"></a>
                                                                <br />
                                                            @endif
                                                        </div>
                                                    </div>
                    ...
                    <div class="modal fade"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>This flight data has one or more
