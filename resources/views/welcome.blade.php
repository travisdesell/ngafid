            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <p>
                            <span class="text-primary"><b>What is digital Flight Data Monitoring (FDM)?</b></span><br>
                        ...
                        <p>
                            <span class="text-primary"><b>Why should I participate in the GA Demonstration Project?</b></span><br>
                            <ul>
                        ...
                        <p>
                            <span class="text-primary"><b>How will this project benefit the GA community?</b></span><br>
                            <ul>
                        ...
                        <p>
                            <span class="text-primary"><b>How can I participate?</b></span><br>
                        ...
                        <p>
                            <span class="text-primary"><b>Download the GAARD (GA Recording Device) App for IOS and Android below</b></span>
                            <span class="col-xs-6">
                                For iOS devices, search for GAARD at the App Store or click here to <br>
                                <a href="https://itunes.apple.com/us/app/general‐aviation‐airborne/id929718718?mt=8">download the free app</a><br>
                                <a href="https://geo.itunes.apple.com/us/app/gaard-general-aviation-airborne/id929718718?mt=8" style="display:inline-block;overflow:hidden;background:url(http://linkmaker.itunes.apple.com/images/badges/en-us/badge_appstore-lrg.svg) no-repeat;width:165px;height:40px;"></a>
                            </span>
                            <span class="col-xs-6">
                                For Android devices, search for GAARD at Google Play or click here to <br>
                                <a href="http://tinyurl.com/gaardapp">download the free app</a><br>
                                <a href="https://play.google.com/store/apps/details?id=org.mitre.asgaard.beta">
                                    <img alt="Android app on Google Play" src="https://developer.android.com/images/brand/en_app_rgb_wo_45.png" style="height:40px" />
                                </a>
                            </span>
                        </p>
                    </div>
