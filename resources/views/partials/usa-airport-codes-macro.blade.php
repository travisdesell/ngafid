<?php
//airport codes obtained from https://github.com/datasets/airport-codes
Form::macro('airportSelect', function($name = 'airport', $selected = null, $options = array()) {
    $airport = array(
        ''     => 'Select Airport',
    ...
    return Form::select($name, $airport, $selected, $options);
});